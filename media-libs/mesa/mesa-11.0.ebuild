...
INTEL_CARDS="intel"
RADEON_CARDS="radeon"
VIDEO_CARDS="${INTEL_CARDS} ${RADEON_CARDS} mach64 mga nouveau r128 savage sis vmware tdfx via freedreno vc4"
...
src_configure() {
	...
	econf \
		...
		--with-gallium-drivers=${GALLIUM_DRIVERS} vc4 \
...
src_install() {
	...
	local gallium_drivers_files=( i915_dri.so swrast_dri.so vc4_dri.so )
